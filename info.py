...
USERNAME = environ.get('USERNAME', "https://t.me/+V7c6rfdKuBphZWQ9") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-6195556018'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+V7c6rfdKuBphZWQ9')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-6195556018').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv:mongodb+srv://Hustle656:Hustle656@hustle656.0xlot.mongodb.net/?retryWrites=true&w=majority&appName=Hustle656")
