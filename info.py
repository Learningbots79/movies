...
BOT_TOKEN = environ.get('BOT_TOKEN', '7904482785:AAETroRbD49sqtqdCJA0R5VHCQ9fjuFni4Y')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1955406483').split()]
USERNAME = environ.get('USERNAME', "https://t.me/jass_beniwal0") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1002190681742'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/movie_request_bot_0')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002315832242').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rs92573993688:pVf4EeDuRi2o92ex@cluster0.9u29q.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "92573993688")
